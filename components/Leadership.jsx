    ...
    >
      ...
      <div className="relative z-10 flex items-center gap-5">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="text-xl sm:text-2xl font-bold text-white leading-tight">{name}</h3>
          <p className={`text-sm font-semibold tracking-wide mt-0.5 ${accent.role}`}>{role}</p>
          ...
          {linkedinUrl && linkedinUrl !== "#" ? (
            ...
            <span className={`mt-2 inline-block text-xs px-2 py-0.5 rounded-full ${accent.badge}`}>
